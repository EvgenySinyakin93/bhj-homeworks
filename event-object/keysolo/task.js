class Game {
  ...
  registerEvents() {
    // Получить DOM-элемент текущего символа, 
    // который необходимо ввести (свойство this.currentSymbol)
    ...
    document.addEventListener('keydown', resultingSymbol);
    }
